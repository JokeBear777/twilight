...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    @Query("SELECT b FROM Book b JOIN BookTags bt ON bt.book = b WHERE bt.tag.tagId = :tagId")
    ...
    """, nativeQuery = true)
    int countBooksByTwoTags(@Param("tagId1") Long tagId1, @Param("tagId2") Long tagId2);
...
""", nativeQuery = true)
    List<Book> findBooksByTwoTags(@Param("tagId1") Long tagId1, @Param("tagId2") Long tagId2);
